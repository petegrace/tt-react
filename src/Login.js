        ...
        return (
            <div>
                ...
                <div className="row featurette mt-5 pt-2 pb-2 alt-featurette">
                    ...
                    <p className="lead">Get yourself into a weekly training routine by scheduling your runs, cross-training and strengthening exercises into a recurring weekly training plan.</p>
                    <p className="lead">Then when you log in each day you’ll be presented with your planned activities and exercises to tick off.</p>
                    <p className="lead">You can create whatever types of exercises you like but if you want some help getting started we’ve provided some templates for simple strengthening plans designed specifically for runners.</p>
                    </div>
                    <div className="col-md-4 order-md-1">
                    <img className="featurette-image img-fluid mx-auto" src={require("./static/img/training_plan.jpg")} alt="Create training plan" />
                    </div>
                </div>
